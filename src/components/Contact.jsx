      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[35ch] reveal-up">
            Reach out to discuss your project needs or explore how my skills can
            contribute to your team. I'm excited to collaborate and deliver
            exceptional results.
          </p>
        ...
        <form
          action="https://getform.io/f/amddwdjb"
          method="POST"
